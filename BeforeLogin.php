    ...
    <div style="height: 600px;">
      <br><br><br><br><br><br>
        <div style="text-align: center;">
          ...
          <a class="btn btn-default" style="background: #f6efff; color:#9122F3; width:15% ; border-radius: 15px;" href="./login.php">เข้าสู่ระบบ</a> <br><br><br><br><br>

          <p2>ยังไม่มีบัญชี?</p2>
          <a class="btn btn-default" style="background-color: #C9D1FD; color: #7500AC; width:8% ; border-radius: 15px;" href="./newRegis.php">ลงทะเบียน</a> <br><br><br>
