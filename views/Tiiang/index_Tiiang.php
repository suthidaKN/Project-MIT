...
<body>
    <div style="background-image: linear-gradient(#ccccff,#cc99ff); background-repeat: no-repeat; background-size: 100% 80%px; text-align: center;">
        <div class="container-fluid" >
            ...
            <a class="btn btn-default" style="background-color: #00cc00; color: #fff" href=?controller=Tiiang&action=search&<?php echo "key=green"?>>สำหรับผู้ป่วยสีเขียว</a>
            <a class="btn btn-default" style="background-color: #FFD000; color: #fff" href=?controller=Tiiang&action=search&<?php echo "key=yellow"?>>สำหรับผู้ป่วยสีเหลือง</a>
            <a class="btn btn-default" style="background-color: #ff8000; color: #fff" href=?controller=Tiiang&action=search&<?php echo "key=orange"?>>สำหรับผู้ป่วยสีส้ม</a>
            <a class="btn btn-default" style="background-color: #ff0000; color: #fff" href=?controller=Tiiang&action=search&<?php echo "key=red"?>>สำหรับผู้ป่วยสีแดง</a>
